...
\item[2.] \textbf{Grinde, K.}$^{+}$, Theobold,  A.$^{+}$, \& Myint,  L$^{+}$. ``Beyond Achievement: Access, Identity, and Power in Alternative Grading." \textit{Grading for Growth} blog guest post (2024): \href{https://gradingforgrowth.com/p/beyond-achievement?r=2ny4pq&utm_campaign=post&utm_medium=web}{[link]}.
	...
	\item[] In December 2024, it was named second on the list of top three guest posts of the year (see \href{https://gradingforgrowth.com/p/grading-for-growth-a-look-back-and?utm_campaign=post&utm_medium=web}{``Grading For Growth: A look back and a look ahead"}).
	\end{footnotesize}
	\end{itemize} %\vspace{-0.1cm}	
...
Submitted to NSF Program No. 21-541 in November 2024. \\
Amount: \$49,440 %\\
