...
\item STAT 155: Introduction to Statistical Modeling (11 sections)  \hfill 2019--present \\
\end{itemize}
...
\begin{itemize}
\item[1.] Barragan, F.$^*$, Mills, L., Raduski, A., Marcotte, E., \textbf{Grinde, K.}, Spector, L., \& Williams, A. ``Genetic ancestry, differential gene expression, and survival in pediatric b-cell acute lymphoblastic leukemia." In revision at \textit{Cancer Medicine}.\\
%	\begin{itemize} \vspace{-0.2cm}
%	\item[] 
%	\begin{footnotesize}
...
%	This work is in revision at \textit{Cancer Medicine}, an Open Access journal that publishes work related to cancer research, biology, and prevention, as well as bioinformatics. 
...
\begin{itemize}
\item[2.] Horimoto, A., Boyken, L., Blue, E., \textbf{Grinde, K.}, Nafikov, R., Sohi, H., Nato, A., Bis, J., Brusco, L., Morelli, L., Ramirez, A., Dalmasso, C., ..., Mayeux, R., Browning, S., Seshadri, S., Wijsman, E., \& Thornton, T. ``Admixture mapping implicates \textit{LIG4}, \textit{MYO16}, and \textit{FAM155A} at 13q33.3 as ancestry-of-origin loci for Alzheimer's disease in multiplex U.S. Caribbean Hispanic Families."
%	\begin{itemize} \vspace{-0.2cm}
%	\item[] \begin{footnotesize} 
...
%	All analyses are complete and a draft of the manuscript has been circulated to co-authors for final checks before submission. 
%	I anticipate that we will submit the paper sometime in the next month or so. 
%	\end{footnotesize}
%	\end{itemize} \vspace{-0.1cm}	
...
\item \sout{Statistical genetics in populations with mixed ancestry. Creighton University Department of Mathematics. Omaha, NE. 2021. (Invited)} (postponed to 2022 due to illness)
...
\textbf{Macalester College Service}
	\begin{itemize} %\itemsep -2pt
	\item Member, Statistics Tenure Track Search Committee \hfill 2022--present
...
%\begin{itemize}
%\item Alayna Johnson \hfill 2022--present
%\item Marshall Roll (primary) \hfill 2022--present
%\item Michael Nadeau  (primary) \hfill 2022--present
%\item Kristy Ma \hfill 2022--present
%\item Eli Ivanov (primary)  \hfill 2022--present
