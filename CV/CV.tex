...
\item STAT 155: Introduction to Statistical Modeling (3 sections) \hfill 2019--2020 \\
Macalester College, Saint Paul, MN
...
\textbf{Fellowships, Scholarships, and Training Grants}
\begin{itemize} 
...
\begin{itemize}
\item[3.] Lin, B.*, \textbf{Grinde, K.}*, Brody, J., Raffield, L., Thornton, T., ..., \& Franceschini, N. ``Discovery of rare genetic variants from whole genome sequencing analyses  of kidney function (eGFR) in 23,732 participants from multi-ethnic populations: the Trans-Omics for Precision Medicine (TOPMed) program." 
	\begin{itemize}
	\item[] *joint first authors
	\end{itemize}
\item[2.] Jensen-Otsu, E., \textbf{Grinde, K.}, Teng, B.J., Baxi, A.C., Harms, M.A., Strate, L.L., \& Ko, C.W. 
``Anesthesia professional-delivered sedation is associated with similar outcomes compared to nurse administered sedation in patients admitted with acute upper gastrointenstinal bleeding." 
\item[1.] Snyder, J., Iwata, T., Patil, K., Tryon, V.,  \textbf{Grinde, K.}, Mizumori, S., Treuting,  \& Treuting, P. 
``Comparison of end-of-life pathology in aged male Fischer 344 and Long Evans rats."  \\
\end{itemize}
...
\begin{benumerate}{22}
\item Statistical genetics in populations with mixed ancestry. Mathematics, Statistics, and Computer Science Colloquium, Augsburg University. Minneapolis, MN, 2020. (\textit{Invited Speaker}) \textbf{(postponed due to COVID-19)}
...
%\item Admixture mapping in TOPMed. TOPMed Kidney Working Group Conference Call. 2019.
...
%\item Admixture mapping in TOPMed. TOPMed Kidney Working Group Conference Call. 2018. 
\item %\textbf{Grinde, K.} 
...
\section{OUTREACH \& MENTORING \\ PRESENTATIONS}
...
\section{SOFTWARE} \textit{STEAM}: Significance Threshold Estimation for Admixture Mapping (R package)
					\begin{itemize} \itemsep -2pt
