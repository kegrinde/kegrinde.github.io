...
\begin{itemize}
\item STAT 155: Introduction to Statistical Modeling (8 sections) \hfill 2019--2021 \\
Macalester College, Saint Paul, MN
...
\begin{benumerate}{24} % eventually: keep only invited talks

%\item[] Creighton Colloquium
%\item[] IGES talk
...
\textbf{Macalester College}
	\begin{itemize} \itemsep -2pt
	%\item Honors Seminar Coordinator
