...
%\item STEAMcpp paper with Zuofu
\end{itemize}
...
\begin{benumerate}{23} % increase this every time a talk is added
...
%\item Academic job panel. American Statistical Association Section on Statistics in Genomics and Genetics. Virtual. 2023. \textbf{(Invited)}
...
\item Tips and Tricks with R/RStudio.  MSCS Student Advisory Board Skill-Building Sessions, Macalester College. 2023 \textbf{(Invited)}

\item \sout{Gender Minorities in Math and Statistics (GeMMS). Carleton College. Northfield, MN. 2023. \textbf{(Invited)}} (postponed due to snow storm)
...
\begin{itemize}
\item Article Processing Charge Grant  \begin{footnotesize}(for Refereed Journal Article [12])\end{footnotesize} \hfill 2022 \\ Macalester College Dewitt Wallace Library Open Access Fund
...
\textbf{Macalester College Service}
	...
	%\item Mentor, new MSCS faculty (Bryan, James, Laura) \hfill 2021--present
	%\item Contributor, Math Targeted Hire \hfill 2023
	...
	%\item Contributor, Math Targeted Hire (hired Yariana Diaz) \hfill 2022--2023
	\item Member, Statistics Tenure Track Search (hired Taylor Okonek) \hfill 2022 
	%\item Contributor, Computer Science Search (hired Suhas Arehalli) \hfill 2022 % met with candidate
	%\item Co-Author, MSCS Community Guidelines \hfill 2022
	%\item Contributor, Disabilitity Services Director Search \hfill 2022 % met with candidate
	%\item Contributor, CS Targeted Hire (hired Joslenne Pena) \hfill 2021--2022
...
%\item Will Brazgel (secondary) \hfill 2022--present
...
%\item Cynthia Zhang \hfill 2023 % summer
